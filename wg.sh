...
# Setting a variable for the link that we want to download.
URL="https://th.bing.com/th/id/R2a25b595eeab9d93bf11a81ae4e3afd3?rik=l2i8sl44rys5Nw&riu=http%3a%2f%2fwww.zastavki.com%2fpictures%2foriginals%2f2014%2fAnimals_Penguins_in_the_Arctic_082032_.jpg&ehk=fg4qGWByBQ6JzQFc%2ftAzcWT5AUwyULkiwodJnyv66mQ%3d&risl=&pid=ImgRaw"

# Now use it to download the file and save it in the system temporary directory.
wget "${URL}" -O /tmp/wg-im
